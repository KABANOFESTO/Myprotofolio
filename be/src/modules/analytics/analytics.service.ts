...
type AnalyticsEventEntity = Prisma.AnalyticsEventGetPayload<{
  select: typeof ANALYTICS_EVENT_SELECT;
}>;
...
export class AnalyticsService {
  ...
  async getSummary(days = 30): Promise<AnalyticsSummaryView> {
    ...
    const [totalEvents, trackedUsers, topEvents, topPaths, recentEvents] =
      await Promise.all([
